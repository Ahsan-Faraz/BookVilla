        ...
        <div className={cn('space-y-6', className)}>
            ...
            >
                ...
                <div className="space-y-4">
                    <h4 className="text-sm font-medium text-[#8a7e6b]">Male Voices</h4>
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="flex items-center gap-2">
                                            <div className={cn(
                                                ...
                                                isSelected ? "border-[#d4770b]" : "border-gray-600"
                                            )}>
                                                {isSelected && <div className="w-2 h-2 rounded-full bg-[#d4770b]" />}
                                            </div>
                                            <span className="font-bold text-[#f5e6c8]">{voice.name}</span>
                                        </div>
                ...
                {/* Female Voices */}
                <div className="space-y-4">
                    <h4 className="text-sm font-medium text-[#8a7e6b]">Female Voices</h4>
                    <div className="voice-selector-options">
